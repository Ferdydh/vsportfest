    ...
    <div className="mt-16">
      ...
      {showModal ? (
        <>
          <div
            id="modal"
            className="transition justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none p-7 md:p-10"
          >
            <div ref={ref}>
