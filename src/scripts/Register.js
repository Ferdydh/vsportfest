...
class Register extends React.Component {
    render() {
      return (
          <section className={this.props.className + " h-screen flex flex-auto relative justify-center content-center bg-gradient-to-br from-blue-900 via-pink-400 to-purple-500 p-10"} id={this.props.id}>
